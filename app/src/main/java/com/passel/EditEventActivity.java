...
public class EditEventActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start_date_data).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                setDate(R.id.start_date_data);
            }
        });

        findViewById(R.id.end_date_data).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setDate(R.id.end_date_data);
            }
        });
        findViewById(R.id.start_time_data).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.end_time_data).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.location_input).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(EditEventActivity.this, LocationPickerActivity.class);
                EditEventActivity.this.startActivityForResult(myIntent, 1);
            }
        });
        ...
        ((TextView) findViewById(R.id.start_date_data)).setText(date.format(event.getStart()));
        ((TextView) findViewById(R.id.end_date_data)).setText(date.format(event.getEnd()));
        ((TextView) findViewById(R.id.start_time_data)).setText(timeFormat.format(event.getStart()));
        ((TextView) findViewById(R.id.end_time_data)).setText(timeFormat.format(event.getEnd()));
    ...
    private boolean editEvent() {
        ...
        final String eventName = eventNameField.getText().toString().trim();
